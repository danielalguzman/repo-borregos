				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_tutoria.php" class="breadcrumb-item">LISTADO DE LAS TUTORÍAS</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">APARTADO DE TUTORÍAS</h5>
						...
						<form action="#">
							...
							<fieldset class="mb-3">
		                        ...
		                        <div class="form-group row">
									<label class="col-form-label col-lg-2"><center>ID</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-vcard"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="ej. 1930007">
										</div>
									</div>
								</div>

		                        <div class="form-group row">
									<label class="col-form-label col-lg-2"><center>FECHA</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-users"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="Ingresa tus nombres sin abreviaciones">
										</div>
									</div>
								</div>

		                        <div class="form-group row">
									<label class="col-form-label col-lg-2"><center>TEMA ATENDIDO</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-cogs"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="ej. Tecnologías de la información">
										</div>
									</div>
								</div>		
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2"><center>EMPLEADO (TUTOR)</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-cogs"></i></span>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2"><center>ID EMPLEADO</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-cogs"></i></span>
