				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_vacaciones.php" class="breadcrumb-item">SOLICITUD-VACACIONES</a>
					...
					<table class="table datatable-button-flash-basic">
						<thead>
							<tr>
								...
								<th><center>EMPRESA PERTENECIENTE</center></th>
								<th><center>DEPARTAMENTO</center></th>
								<th><center>PUESTO</center></th>
								<th><center>PERIODO DE VACACIONES</center></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td><center>Tomas Dosal</center></td>
								<td><center>Gamesa Industries</center></td>
								<td><center>Recursos Humanos</center></td>
								<td><center>Secetario</center></td>
								<td><center>08/Abril/2008 - 22/Abril/2008</center></td>								
							</tr>
							<tr>
								<td>
									<button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_form_vertical"> <i class="icon-pencil7"></i></button>
								...
								<td><center>008</center></td>
								<td><center>Enrique Hernandez</center></td>
								<td><center>Mary Industries</center></td>
								<td><center>Informatica</center></td>
								<td><center>Programador</center></td>
								<td><center>21/Enero/2008 - 28/Enero/2008</center></td>
							</tr>
							<tr>
								<td>
									<button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_form_vertical"> <i class="icon-pencil7"></i></button>
								...
								<td><center>Orlando Zapata</center></td>
								<td><center>Canno Industries</center></td>
								<td><center>Contabilidad</center></td>
								<td><center>Auxiliar Contable</center></td>
								<td><center>18/Marzo/2008 - 25/Marzo/2008</center></td>
							</tr>
							<tr>
								<td>
									<button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_form_vertical"> <i class="icon-pencil7"></i></button>
								...
								<td><center>004</center></td>
								<td><center>Rodrigo Barrón</center></td>
								<td><center>Pacos Industries</center></td>
								<td><center>Producción</center></td>
								<td><center>Auxiliar Operativo</center></td>
								<td><center>06/Mayo/2008 - 20/Mayo/2008</center></td>
							</tr>
							<tr>
								<td>
									<button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_form_vertical"> <i class="icon-pencil7"></i></button>
								...
								<td><center>Fernanda Rodriguez</center></td>
								<td><center>Daniela Industries</center></td>
								<td><center>Informática</center></td>
								<td><center>Auxiliar</center></td>
								<td><center>03/Junio/2008 - 17/Junio/2008</center></td>
							</tr>
							<tr>
								<td>
									<button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_form_vertical"> <i class="icon-pencil7"></i></button>
								...
								<td><center>Pedro Arriaga</center></td>
								<td><center>Canno Industries</center></td>
								<td><center>Contabilidad</center></td>
								<td><center>Auxiliar Contable</center></td>
								<td><center>08/Julio/2008 - 22/Julio/2008</center></td>
							</tr>
							<tr>
						</tbody>
					</table>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">EDICION DE SOLICITUD DE VACACIONES</h5>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
									...
									<div class="form-group">
									    ...
									    <fieldset class="mb-3">
		                        			<div class="form-group row">
		                        				<label class="col-form-label col-lg-2"><center>EMPRESA</center></label>
		                        				<div class="col-lg-10">
			                            			<select class="form-control">
			                                			<option value="opt1"><center>- SELECCIONA EMPRESA LA PERTENECIENTE -</center></option>
			                                			<option value="opt1">Mary Industries</option>
			                                			<option value="opt2">Gamesa Industries</option>
			                                			<option value="opt3">Canno Industries</option>
			                                			<option value="opt4">Lalo Industries</option>
			                                			<option value="opt5">Pacos Inustries</option>
			                            			</select>
		                            			</div>
		                        			</div>

		                        			<div class="form-group row">
		                        				<label class="col-form-label col-lg-2"><center>DEPARTAMENTO</center></label>
		                        				<div class="col-lg-10">
			                            			<select class="form-control">
			                                			<option value="opt1"><center>- SELECCIONA DEPARTAMENTO PERTENECIENTE -</center></option>
			                                			<option value="opt1">RECURSOS HUMANOS</option>
			                                			<option value="opt2">INFORMÁTICA</option>
			                                			<option value="opt3">PRODUCCIÓN</option>
			                                			<option value="opt4">COMPRAS</option>
			                                			<option value="opt5">CONTABILIDAD</option>
			                            			</select>
		                            			</div>
		                        			</div>	
		                        		</fieldset>
										...
										<div class="row" align="center">
											...
											<div class="col-sm-6">
												<br>
												<label>FECHA PERIODO VACACIONAL</label>
