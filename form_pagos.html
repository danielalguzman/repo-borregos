			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">REGISTRO DE PAGOS</span> </h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">PAGOS DE TRANSPORTE</h5>
					...
					<div class="card-body">
						<p class="mb-4">En este apartado te ayudará a tener un mejor manejo de de dinero y datos de los alumnos que deseen comprar su boleto de transporte en la Universidad Politécnica de Victoria. </p>
						...
						<form action="#">
							...
							<fieldset class="mb-3">
		                        ...
		                        <div class="form-group row">
									<label class="col-form-label col-lg-2"><center>MATRÍCULA</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-magazine"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="Inserta la matricula del alumno">
										</div>
									</div>
								</div>

		                        <div class="form-group row">
									<label class="col-form-label col-lg-2"><center>NOMBRE DEL ALUMNO</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-user"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="ej. Daniela Guzman">
										</div>
									</div>
								</div>

		                        <div class="form-group row">
									<label class="col-form-label col-lg-2"><center>CARRERA</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class=" icon-city "></i></span>
											</span>
											<input type="text" class="form-control" placeholder="ej. Tecnologías de la Informacion">
										</div>
									</div>
								</div>
							</fieldset>							
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2"><center>HORARIO</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-watch"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="ej. 7:00 a.m">
										</div>
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2"><center>FECHA DE PAGO</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class=" icon-calendar "></i></span>
											</span>
											<input type="text" class="form-control" placeholder="ia / mes / añdo">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2"><center>RUTA</center></label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
...
icon-bus"></i></span>
											...
											<input type="text" class="form-control" placeholder=" ej. Tamatan">
										</div>
									</div>
								</div>
					            ...
					            <div class="table-responsive" align="center">
								    <br>
							        <button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_default"><center>GUARDAR REGISTRO</center><i class="icon-checkmark3"></i></button>
							        <br><br>
							    </div>    
