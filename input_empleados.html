		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">FORMULARIO</span> - EMPLEADOS</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_empleado.php" class="breadcrumb-item">TABLA-EMPLEADOS</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4"><center>En este apartado podras darte de alta a los empleados quepertenecen a nuestra empresa para poder llevar un orden de cada uno de ellos.<br> Solo tendras que llenar cada uno de los campos solicitados.</center></p>

						<form action="#">

							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">DATOS GENERALES</legend>
							...
							<fieldset class="mb-3">
								<div class="form-group row">
									<label class="col-form-label col-lg-2">FECHA DE INGRESO </label><br><br>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-menu6"></i></span>
