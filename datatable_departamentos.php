	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div cldass="page-header-content header-elements-md-inline">
					<iv class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"> </span>DEPARTAMENTO</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_departamentos.php" class="breadcrumb-item">FORMULARIO-DEPARTAMENTOS</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<center>En el siguiente listado encontrarás los diferentes departamentos que tenemos en nuestras empresas.</center>
					</div>
					...
					<table class="table datatable-basic table-bordered">
						<thead>
							<tr>
								...
								<th>   </th>
								<th> CLAVE </th>
								<th><center> NOMBRE DEL DEPARTAMENTO </center></th>
								<th><CENTER> NOMBRE DEL RESPONSABLE </CENTER></th>
						...
						<tbody>
							<tr>
								...
								<td><center>Fernanda Coronado</center></td>
								<td><center>Directora en Jefe</center></td>
								<td><center>46580</center></td>
							...
							<tr>
								...
								<td><center>Gerardo López</center></td>
								<td><center>Obrero</center></td>
								<td><center>34956</center></td>
							</tr>
							...
							<tr>
								...
								<td><center>Simón Coronado</center></td>
								<td><center>Director en Jefe</center></td>
								<td><center>88701</center></td>
							</tr>
							...
							<tr>
								...
								<td><center>Daniela Guzmán</center></td>
								<td><center>Contadora</center></td>
								<td><center>14142</center></td>
							</tr>
							...
							<tr>
								...
								<td><center>Epifanio Báez</center></td>
								<td><center>Director en Jefe</center></td>
								<td><center>10249</center></td>
							</tr>
							...
							<tr>
								...
								<td><center>José Ramírez</center></td>
								<td><center>Auxiliar</center></td>
								<td><center>21846</center></td>
							</tr>
						</tbody>
					</table>
				</div>
